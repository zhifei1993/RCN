...
def main():
    ...
    parser.add_argument('--model_name', type=str, default="ComConV", help='ComConV')
    parser.add_argument('--dataset', type=str, default="countries/countries_S3",
    ...
    parser.add_argument('--optimizer_method', type=str, default="RAdam", help='optimizer method')
